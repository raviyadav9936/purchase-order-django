...
class PurchaseOrder(models.Model):
    ...
    taxable_total = models.DecimalField(max_digits=14, decimal_places=2, null=True, blank=True)
    tax_total = models.DecimalField(max_digits=14, decimal_places=2, null=True, blank=True)
